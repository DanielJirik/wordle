...
class User implements UserInterface, PasswordAuthenticatedUserInterface
{
     ...
     */
    #[ORM\OneToMany(targetEntity: UserWordleAnswer::class, mappedBy: 'user', orphanRemoval: true)]
    ...
    public function removeUserWordleAnswer(UserWordleAnswer $userWordleAnswer): static
    {
        if ($this->userWordleAnswers->removeElement($userWordleAnswer)) {
            ...
            if ($userWordleAnswer->getUser() === $this) {
                $userWordleAnswer->setUser(null);
            }
        }
